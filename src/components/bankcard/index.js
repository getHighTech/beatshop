...
import { removeBankCard } from  '../../actions/bankcards';
...
class Bankcard extends React.Component{
  ...
  unBound = (cardId ) => {
    this.props.dispatch(removeBankCard(cardId))
  }
        ...
        <Card className={classes.card}>
        {
          ...
          {this.props.isBankcard===true?
            <CardActions style={{textAlign:'right',display:'list-item'}}>
              <Button size="small" variant="raised" color="secondary" onClick={()=> this.unBound(cardId)}>解除绑定</Button>
            </CardActions>:            
